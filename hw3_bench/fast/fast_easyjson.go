...
func easyjson3486653aDecodeCourseraHw3BenchFast(in *jlexer.Lexer, out *User) {
...
func easyjson3486653aEncodeCourseraHw3BenchFast(out *jwriter.Writer, in User) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v User) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3486653aEncodeCourseraHw3BenchFast(&w, v)
...
func (v *User) UnmarshalJSON(data []byte) error {
	...
	easyjson3486653aDecodeCourseraHw3BenchFast(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *User) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3486653aDecodeCourseraHw3BenchFast(l, v)
}
